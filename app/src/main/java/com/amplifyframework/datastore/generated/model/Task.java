...
public final class Task implements Model {
  ...
  public Temporal.DateTime getDateAdded() {
      return dateAdded;
  }
  ...
  private Task(String id, String title, String description, Temporal.DateTime dateAdded, TaskProgressEnum progress, String taskImageS3Key, String taskLatitude, String taskLongitude, Team teamName) {
    this.id = id;
    this.title = title;
  ...
  public static class Builder implements TitleStep, BuildStep {
    ...
    @Override
     public BuildStep dateAdded(Temporal.DateTime dateAdded) {
        this.dateAdded = dateAdded;
        return this;
    }
    
    @Override
     public BuildStep progress(TaskProgressEnum progress) {
        this.progress = progress;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String description, Temporal.DateTime dateAdded, TaskProgressEnum progress, String taskImageS3Key, String taskLatitude, String taskLongitude, Team teamName) {
      super.id(id);
      super.title(title)
    ...
    @Override
     public CopyOfBuilder dateAdded(Temporal.DateTime dateAdded) {
      return (CopyOfBuilder) super.dateAdded(dateAdded);
    }
    
    @Override
     public CopyOfBuilder progress(TaskProgressEnum progress) {
